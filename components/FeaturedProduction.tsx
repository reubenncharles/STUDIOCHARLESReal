              ...
              {isPlaying ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0">
                    ...
                    {/* Client badge */}
                    <div className="absolute top-6 left-6 px-3 py-1 bg-black/60 backdrop-blur-sm border border-zinc-700 text-amber-500 text-xs font-bold uppercase tracking-widest">
                      {project.client}
                    </div>
                  </div>
